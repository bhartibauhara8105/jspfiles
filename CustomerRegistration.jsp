...
try {
 ...
 //  PreparedStatement s=con.prepareStatement("insert into customerregister(Password,ConfirmPassword,FirstName,LastName,Gender,Age,TelephoneNo,MobileNo,Email,Address,Pincode,AnnualIncome)values(?,?,?,?,?,?,?,?,?,?,?,?)");
